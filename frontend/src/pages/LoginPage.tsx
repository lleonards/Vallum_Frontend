...
import { FileText, Mail, Lock, Eye, EyeOff, Sun, Moon, ArrowLeft } from 'lucide-react'
        ...
        <div className="w-full max-w-md">
          ...
          <div className="card p-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-8">
              Não tem uma conta? <Link to="/register" className="text-primary-600 hover:underline font-medium">Cadastre-se</Link>
            </p>
              ...
              >
                {loading ? (
                  <span className="flex items-center gap-2">
                    <div className="loader w-4 h-4" /> Entrando...
                  </span>
                ) : 'Entrar'}
              </button>
            </form>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-2 bg-white dark:bg-dark-800 text-gray-400">ou continue com</span>
              </div>
            </div>
